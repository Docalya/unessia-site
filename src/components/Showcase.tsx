...
const gallery = [
  { src: "/app/planning.png", label: "Planning", alt: "Vos tâches et rendez-vous, réunis dans un agenda clair." },
  { src: "/app/budget.png", label: "Budget", alt: "Vos dépenses réparties par catégorie, en un coup d'œil." },
  { src: "/app/budget2.png", label: "Suivi mensuel", alt: "L'évolution de votre solde mois après mois." },
  { src: "/app/aides.png", label: "Aides", alt: "Les aides auxquelles vous pourriez avoir droit." },
];
    ...
    <section id="comment-ca-marche" className="px-5 py-12 sm:px-8 sm:py-28">
      <div className="mx-auto max-w-6xl">
        <div className="grid items-center gap-9 sm:gap-14 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <Phone src="/app/accueil.png" alt="Écran d'accueil de Unessia : point sérénité et actions rapides." />
          </motion.div>
        </div>
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={viewportOnce}
          className="mt-12 sm:mt-20 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4 sm:gap-8"
        >
          {gallery.map((s) => (
